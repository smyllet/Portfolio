...
<main>
    ...
    <section>
        <h2>Motivations</h2>
        <p>Etant régulièrement à Disneyland Paris, je communique souvent avec des collectionneurs de pins. Au fil des discussions, nous avons remarqué qu’il n’y avait aucun service les référençant. Il est donc tout naturel, lorsqu'on a dû choisir nos projets, que l'un d'eux se soit orienté vers cette thématique.</p>
    </section>
    <section>
        ...
        <div class="logo_container">
            ...
            <img src="https://upload.wikimedia.org/wikipedia/fr/thumb/6/62/MySQL.svg/1200px-MySQL.svg.png" alt="logo mysql">
        </div>
    </section>
    <section>
    ...
    <section>
        <h2>Modélisation</h2>
        <img src="/img/dpdb.svg" alt="UML Disney Pins DataBase" class="uml">
    </section>
</main>
</body>
</html>